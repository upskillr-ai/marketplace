...
class Config:
    ...
    def __init__(self, config_file: str = None):
        ...
        self.summary_token_limit = int(os.getenv('SUMMARY_TOKEN_LIMIT', 2700))
        self.temperature = float(os.getenv('TEMPERATURE', 0.3))
        self.llm_temperature = float(os.getenv('LLM_TEMPERATURE', 0.3))  # Add this line
        self.user_agent = os.getenv('USER_AGENT', "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 "
                                                   "(KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36 Edg/119.0.0.0")
        self.max_search_results_per_query = int(os.getenv('MAX_SEARCH_RESULTS_PER_QUERY', 8))
        self.memory_backend = os.getenv('MEMORY_BACKEND', "local")
        self.total_words = int(os.getenv('TOTAL_WORDS', 1800))
